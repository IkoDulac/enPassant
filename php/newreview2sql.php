...
if ($_POST['review'] == null || !isset($_SESSION['userID']) || ($_POST['userID'] == $_SESSION['userID'])) {
	...
	$query = "INSERT INTO $table (user_from, username_from, user_to, review) VALUES ($1, $2, $3, $4);";
	$result = pg_query_params($connection, $query, array($userFrom, $username, $userTo, $review)) or die('Query failed: ' . pg_last_error());
